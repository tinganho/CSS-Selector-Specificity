...
var Specificity = (function(){
    ...
    var pseudoClassesCSS2 = 
    [':first-child', ':link', ':visitied', ':hover', ':active', ':focus', ':lang'];
    ...
    [':nth-child', ':nth-last-child', ':nth-of-type', ':nth-of-last-type',
     ':first-of-type', ':last-of-type', ':only-child', ':only-of-type',  ':root', ':empty', 
     ':target', ':enabled', ':disbaled', ':checked', ':not'];
    ...
    C.getBiggestPoint = function(points) {
    ...
    C.specificity = function(selector, element) {
